...
if (!window.confirm("Are you sure you want to delete thisbook?")) return;
try {
...
<input type="text" placeholder="Book author" className="input input-
bordered" value={book.author} onChange={(e) => setBook({ ...book,
...
<input type="number" placeholder="Year" className="input input-
bordered" value={book.publishYear} onChange={(e) =>
